-- SOLUCION AL ERROR: Column 'asignacion_id' cannot be null
-- Aplicar migracion V7 manualmente
...
-- 4. Agregar campos de auditoria faltantes (si no existen)
ALTER TABLE plan_ejecucion 
...
-- 5. Verificar que la migracion se aplico correctamente
SELECT 
    COLUMN_NAME, 
    IS_NULLABLE,
    DATA_TYPE 
