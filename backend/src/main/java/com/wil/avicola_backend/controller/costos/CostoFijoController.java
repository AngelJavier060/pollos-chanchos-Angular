...
import com.wil.avicola_backend.service.costos.CostoFijoService;
...
public class CostoFijoController {
    ...
    private final CostoFijoService service;

    @PostMapping
    public ResponseEntity<CostoFijo> crear(@Valid @RequestBody CostoFijoDTO body) {
        return ResponseEntity.ok(service.crear(body));
    }

    @GetMapping
    public ResponseEntity<List<CostoFijo>> listar(
    ...
    @GetMapping("/{id}")
    public ResponseEntity<CostoFijo> obtener(@PathVariable String id) {
        return ResponseEntity.ok(service.obtener(id));
    }

    @PutMapping("/{id}")
    public ResponseEntity<CostoFijo> actualizar(@PathVariable String id, @Valid @RequestBody CostoFijoDTO body) {
