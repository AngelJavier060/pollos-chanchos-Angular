...
@Builder
@Entity
@Table(name = "venta_huevo")
@EntityListeners(AuditingEntityListener.class)
public class VentaHuevo {
    ...
    // Lote de origen (UUID en backend). No hacemos FK para mantener simplicidad (igual a MovimientoInventario)
    @NotNull
